...
import {
  lessonHourPreparationAiGenerateExpectedResultArrangementService ,
  lessonHourPreparationGetExpectedResultByIdService,
  lessonHourPreparationSaveExpectedResultService} from '@/api/lessonHourPreparationLesson.js'
...
const sendMessage = async () => {
  ...
  try {
    // 调用实际的API服务
    const res = await lessonHourPreparationAiGenerateExpectedResultArrangementService(teacherScheduleId)
...
onMounted(async () => {
  initChat()
  try {
    const res = await lessonHourPreparationGetExpectedResultByIdService(teacherScheduleId)
...
const saveResults = async () => {
  ...
  try {
    // 这里添加保存API调用
    await lessonHourPreparationSaveExpectedResultService(teacherScheduleId, {
