...
const teachingSignDto = ref({
  teacherScheduleId: chapterLessonPreparationId,
})
...
const goAiGenerate = async () => {
  ...
  const res = await chapterLessonPreparationAiGenerateTeachingSignService(chapterLessonPreparationId)
  console.log(res)
...
const saveContent = async () => {
  const res = await chapterLessonPreparationUpdateService(chapterLessonPreparationId, AiGenerateTeachingSign.value)
  console.log(res)
...
const goToTeachingActivities = () => {
  router.push(`/lesson/mylessonpreparation/TeachingActivitiesArrangement/${chapterLessonPreparationId}`)
}

const goToTimeAllocation = () => {
  router.push(`/lesson/mylessonpreparation/TimeAllocation/${chapterLessonPreparationId}`)
}

const goToExpectedResults = () => {
  router.push(`/lesson/mylessonpreparation/ExpectedResult/${chapterLessonPreparationId}`)
}
